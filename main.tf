...
module "autoscaling_groups" {
  ...
  public_subnet_id = "${module.site.public_subnet_id}"
 # public_subnet_id1 = "${module.site.public_subnet_id1}"
  private_subnet_id = "${module.site.private_subnet_id}"
  private_subnet_id1 = "${module.site.private_subnet_id1}"
  ...
  webapp_lc_id1 = "${module.launch_configurations.webapp_lcc_id1}"
  webapp_lc_name1 = "${module.launch_configurations.webapp_lcc_name1}"
  webapp_elb_name1 = "${module.load_balancers.webapp_elb_name1}"
}
module "instances" {
  source = "./instances"
  public_subnet_id = "${module.site.public_subnet_id}"
